...
@interface CPWebViewController () <UIWebViewDelegate, UIGestureRecognizerDelegate>
...
- (void)viewWillAppear:(BOOL)animated {
    NSAssert(self.navigationController, @"CPWebViewController needs to be contained in a UINavigationController. If you are presenting CPWebViewController modally, use SVModalWebViewController instead.");
...
- (UIBarButtonItem *)backBarButtonItem {
    if (!_backBarButtonItem) {
        _backBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"CPWebViewController.bundle/CPWebViewControllerBack"]
...
- (UIBarButtonItem *)forwardBarButtonItem {
    if (!_forwardBarButtonItem) {
        _forwardBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"CPWebViewController.bundle/CPWebViewControllerNext"]
                                                                 style:UIBarButtonItemStylePlain
                                                                target:self
