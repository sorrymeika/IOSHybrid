...
- (void)viewDidLoad
{
    ...
    plugins=@{
              ...
              @"cmcc": [[CMCCPlugin alloc] initWithHybridView:hybridView],
              @"qrcode": [[QRCodePlugin alloc] initWithHybridView:hybridView],
              @"contact": [[ContactPlugin alloc] initWithHybridView:hybridView],
              @"motion": [[MotionPlugin alloc] initWithHybridView:hybridView]
            };
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    if ([hybridView.WEBVIEW_TYPE isEqualToString:@"WKWebView"]) {
        [hybridView evaluateJavaScript:[NSString stringWithFormat: @"$(window).trigger('keyboardWillShow',%f);", keyboardRect.size.height]];
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    if ([hybridView.WEBVIEW_TYPE isEqualToString:@"WKWebView"]) {
        [hybridView evaluateJavaScript:@"$(window).trigger('keyboardWillHide');"];
...
- (void)motionEnded:(UIEventSubtype)motion withEvent:(UIEvent *)event
{
    if (motion == UIEventSubtypeMotionShake) {
        NSLog(@"stop");
        [hybridView evaluateJavaScript:@"$(window).trigger(\"motion\")"];
    }
}
